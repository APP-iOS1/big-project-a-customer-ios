...
struct PurchaseDetail: View {
    ...
    var body: some View{
        VStack(spacing: 15){
            ...
            ForEach(0..<3){ _ in
                VStack {
                    PurchaseListCell(orderStore: orderStore, order: DummyOrderInfo(orderDate: "2022. 12. 27", itemAmount: 1, price: 24900, deliveryStatusText: "배송중", itemName: "유그린 메탈쉘 외장하드 케이스 C to USB3.0", itemImage: "itemImage", isSelected: false), index: 1, isDeliveryCompleted: $check)
                }
            }
            Button {
                // 구매 후기 쓰기
