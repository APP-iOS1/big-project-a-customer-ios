...
struct SignUpStep2View: View {
    ...
    func checkNicknameDuplicated() {
        Task {
            if await signUpViewModel.isNicknameDuplicated(currentUserNickname: nickName) {
                // 이메일이 중복될 경우
                isDuplicated = true
    ...
    var body: some View {
        ...
        VStack {
            ...
            VStack(spacing: 5) {
                HStack {
                    ...
                    if !nickName.isEmpty {
                        ...
                        if signUpViewModel.nickNameDuplicationState == .duplicated {
                            Button {
                        ...
                        } else if signUpViewModel.nickNameDuplicationState == .checking{
                            ProgressView()
            ...
            Button {
                ...
                Task {
                    if signUpViewModel.nickNameDuplicationState == .notDuplicated {
            ...
            .disabled(nickName.isEmpty || nickName.count > 20 || signUpViewModel.nickNameDuplicationState != .notDuplicated ? true : false)
        } // VStack
