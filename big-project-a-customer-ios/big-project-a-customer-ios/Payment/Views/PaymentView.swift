...
struct PaymentView: View {
    ...
    /// 주문하기로 결정한 아이템들
    let selectedOrderItems: [OrderItemInfo]
...
//                PaymentCompleteView(purchaseInfo: $purchaseInfo, isCashCheck: isCashCheck)
                PaymentCompleteView(purchaseInfo: $purchaseInfo, isCashCheck: isCashCheck, shippingAddress: shippingAddress, orderedItems: selectedOrderItems)
            }){
